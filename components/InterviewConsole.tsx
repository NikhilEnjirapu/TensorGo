      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="mt-3 text-gray-400 text-sm sm:text-base">
            Interact with our premium real-time telemetry assessment dashboard directly. Hit play below to see Zai join the call and parse candidate telemetry.
          </p>
        </div>

        {/* Browser Mockup Wrapper */}
        <div className="max-w-6xl mx-auto glass-card rounded-2xl border border-white/10 shadow-2xl shadow-black/85 overflow-hidden">
          
          {/* Browser Header Bar */}
          <div className="bg-black/90 px-4 py-3 flex items-center justify-between border-b border-white/5">
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-rose-500 inline-block" />
              <span className="w-3 h-3 rounded-full bg-amber-500 inline-block" />
              <span className="w-3 h-3 rounded-full bg-emerald-500 inline-block" />
            </div>
            <div className="bg-white/5 border border-white/5 rounded-lg px-4 py-1 text-[11px] font-mono text-gray-400 w-1/2 max-w-sm text-center truncate">
          ...
          <div className="flex h-[680px] bg-[#070708] mesh-grid text-gray-300 font-sans relative overflow-hidden">
            
            {/* Left Sidebar (Dark Indigo) */}
            <aside className="w-[64px] bg-black/90 shrink-0 flex flex-col items-center justify-between py-6 border-r border-white/5 z-10">
              <div className="flex flex-col items-center gap-8 w-full">
                ...
                <nav className="flex flex-col items-center gap-4 w-full">
                  ...
                  <button className="p-2.5 rounded-xl text-white bg-white/10 border border-white/10 transition-all cursor-pointer shadow-md">
                    <Folder size={18} />
                  </button>
                  <button className="p-2.5 rounded-xl text-gray-500 hover:text-white transition-colors cursor-pointer">
                    <Briefcase size={18} />
            ...
            <div className="flex-1 flex flex-col overflow-hidden min-w-0">
              ...
              {/* Internal Header Bar */}
              <header className="bg-black/40 backdrop-blur-md border-b border-white/5 px-6 py-4 flex items-center justify-between shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <h1 className="text-base font-bold text-white">Hemaja Consultancy</h1>
              ...
              <div className="flex-1 overflow-y-auto p-4 lg:p-6 min-w-0">
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                  ...
                  <div className="xl:col-span-7 flex flex-col gap-6 min-w-0">
                    ...
                    {/* Video Console Frame */}
                    <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl border border-white/5 p-3 shadow-sm relative aspect-video overflow-hidden group">
                      
                      {/* AI Interviewer Video (Main screen) */}
                      <div className="w-full h-full rounded-lg bg-black/90 relative overflow-hidden flex items-center justify-center border border-white/5">
                        {step === 0 && candidateState === "connecting" ? (
                          <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400 font-mono gap-3 p-4 text-center">
                      ...
                      <div className="absolute bottom-6 right-6 w-[140px] md:w-[170px] aspect-video rounded-lg border-2 border-white/10 shadow-2xl shadow-black/80 overflow-hidden bg-slate-950 z-10 transition-transform group-hover:scale-105">
                        {step === 0 && candidateState === "connecting" ? (
                        ...
                        <div className="absolute bottom-1.5 left-1.5 bg-black/60 backdrop-blur-md px-2 py-0.5 rounded text-[8px] text-white font-mono flex items-center gap-1 border border-white/5">
                          <span className={`w-1 h-1 rounded-full ${candidateState === "answering" ? "bg-rose-500 animate-ping" : "bg-gray-500"}`} />
                          <span>Hemaja</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/[0.02] backdrop-blur-sm rounded-xl border border-white/5 p-4 shadow-sm">
                      ...
                      <div className="flex border-b border-white/5 gap-4 mb-4 text-xs font-bold font-mono">
                        <span className="text-accent-blue border-b-2 border-accent-blue text-glow-blue pb-2 cursor-pointer uppercase tracking-wider">
                          Speaker Diarization
                        </span>
                        <span className="text-gray-500 hover:text-gray-300 pb-2 cursor-pointer uppercase tracking-wider">
                          Notes
                        </span>
                        <span className="text-gray-500 hover:text-gray-300 pb-2 cursor-pointer uppercase tracking-wider">
                          Clips
                      ...
                      <div className="space-y-4 pt-2">
                        ...
                        {/* Hemaja Track */}
                        <div className="flex items-center justify-between text-xs font-mono">
                          <div className="w-12 font-bold text-gray-400">Hemaja</div>
                          <div className="flex-1 mx-4 h-6 bg-white/5 rounded-md overflow-hidden relative border border-white/5">
                      ...
                      <div className="flex items-center justify-between border-b border-white/5 pb-2 mb-4 shrink-0 overflow-x-auto no-scrollbar">
                        <div className="flex gap-3 text-[10px] font-bold font-mono uppercase tracking-wider">
                          <button
                            ...
                            className={`pb-2 border-b-2 transition-colors cursor-pointer ${activeTab === "health" ? "border-accent-blue text-accent-blue" : "border-transparent text-gray-500 hover:text-gray-300"}`}
                          >
                            Health Metrics
                          </button>
                          <button
                            onClick={() => setActiveTab("biometric")}
                            className={`pb-2 border-b-2 transition-colors cursor-pointer ${activeTab === "biometric" ? "border-accent-blue text-accent-blue" : "border-transparent text-gray-500 hover:text-gray-300"}`}
                          >
                            Biometric
                          </button>
                          <button
                            onClick={() => setActiveTab("insights")}
                            className={`pb-2 border-b-2 transition-colors cursor-pointer ${activeTab === "insights" ? "border-accent-blue text-accent-blue" : "border-transparent text-gray-500 hover:text-gray-300"}`}
                          >
                            Zai Insights
                          </button>
                          <button
                            onClick={() => setActiveTab("audio")}
                            className={`pb-2 border-b-2 transition-colors cursor-pointer ${activeTab === "audio" ? "border-accent-blue text-accent-blue" : "border-transparent text-gray-500 hover:text-gray-300"}`}
                          >
                            Audio
                          </button>
                        </div>
                              ...
                              <div className="grid grid-cols-2 gap-3 pt-2">
                                ...
                                <div className="border border-white/5 rounded-xl p-3 bg-white/[0.01] hover:border-white/10 hover:bg-white/[0.03] transition-all shadow-sm flex flex-col justify-between h-[80px]">
                                  <div>
                                    ...
                                    <div className="text-lg font-extrabold text-white font-mono mt-0.5">
                                      {45 + (elapsedTime % 3)} <span className="text-[10px] font-normal text-gray-500">ms</span>
                                    </div>
                                  </div>
                                ...
                                <div className="border border-white/5 rounded-xl p-3 bg-white/[0.01] hover:border-white/10 hover:bg-white/[0.03] transition-all shadow-sm flex flex-col justify-between h-[80px]">
                                  <div>
                                    ...
                                    <div className="text-lg font-extrabold text-white font-mono mt-0.5">
                                      {biometrics.stressIndex} <span className="text-[9px] text-gray-500 font-normal">/10</span>
                                    </div>
                                  </div>
                                ...
                                <div className="border border-white/5 rounded-xl p-3 bg-white/[0.01] hover:border-white/10 hover:bg-white/[0.03] transition-all shadow-sm flex flex-col justify-between h-[80px]">
                                  <div>
                                    ...
                                    <div className="text-lg font-extrabold text-white font-mono mt-0.5">
                                      {14 + (elapsedTime % 3)} <span className="text-[10px] font-normal text-gray-500">BrPm</span>
                                    </div>
                                  </div>
                                  <div className="w-full bg-white/5 h-1 rounded-full overflow-hidden mt-2">
                                ...
                                <div className="space-y-3">
                                  ...
                                  <div className="flex items-center gap-3 bg-white/[0.01] border border-white/5 p-2.5 rounded-lg shadow-sm">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="font-bold text-white text-[11px] truncate">himajakolavennu@gmail.com</div>
                              ...
                              <div className="bg-white/[0.01] border border-white/5 rounded-lg p-3 h-[380px] overflow-y-auto text-[10px] font-sans leading-relaxed space-y-3">
                                ...
                                {step < 3 ? (
                                  ...
                                  <div className="space-y-4">
                                    <div>
                                      <h4 className="font-bold text-white text-[11px] mb-1">1. Candidate Overview</h4>
                                    ...
                                    <div>
                                      <h4 className="font-bold text-white text-[11px] mb-1">2. Communication Style</h4>
                                      <p className="text-gray-400">
                                    ...
                                    <div>
                                      <h4 className="font-bold text-white text-[11px] mb-1">3. Storytelling & Technical Competency</h4>
                                      <p className="text-gray-400">
                              ...
                              <div className="space-y-3 pt-2">
                                ...
                                <div className="space-y-1">
                                  <div className="flex justify-between font-mono text-[10px]">
                                    ...
                                    <span className="font-bold text-gray-300">{isActive ? "134 WPM" : "0 WPM"}</span>
                                  </div>
                                  <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                                    <div className="bg-accent-emerald h-full rounded-full" style={{ width: "68%" }} />
                                  </div>
                                </div>
                                ...
                                <div className="space-y-1">
                                  ...
                                  <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden">
                                    <div className="bg-accent-blue/80 h-full rounded-full" style={{ width: "15%" }} />
                                  </div>
                                </div>
                              </div>
                            </motion.div>
